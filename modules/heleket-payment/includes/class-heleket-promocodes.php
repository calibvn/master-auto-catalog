...
class Heleket_Promocodes
{
    ...
    public function check_promocodes_table_exists()
    {
        ...
        $table_name = $wpdb->prefix . 'heleket_promocodes';
...
?>
        <div class="wrap">
            <h1>Управление промокодами Heleket</h1>
            ...
            <div class="card full" style="margin-bottom: 20px;">
                ...
                <form method="post">
                    <table class="form-table">
                        ...
                        <tr>
                            <td><input type="text" name="promocode" placeholder="PROMO2024" class="regular-text" required /></td>
                            <td><input type="text" name="comment" placeholder="Комментарий" class="regular-text" /></td>
                            <td><input type="number" step="0.01" name="price" value="30" class="small-text" required /></td>
                        ...
                        <?php if ($promocodes): ?>
                            <?php foreach ($promocodes as $promo): ?>
                                <tr>
                                    ...
                                    <td>
                                        <span class="heleket-status heleket-status-<?php echo $promo->is_active ? 'active' : 'inactive'; ?>">
                                    ...
                                    <td>
                                        ...
                                        <a href="?page=heleket-promocodes&delete_promocode=<?php echo $promo->id; ?>"
                    ...
                    <div>
                        ...
                        <form method="post" id="edit-promo-form">
                            ...
                            <table class="form-table">
                                ...
                                <tr>
                                    <th>Цена ($)</th>
                                    <td><input type="number" step="0.01" name="price" id="edit-promo-price" class="small-text" required /></td>
                                </tr>
                                <tr>
                                    <th>Использовано</th>
...
<?php
    ...
    public function use_promocode($promocode)
    {
        ...
        $table_name = $wpdb->prefix . 'heleket_promocodes';
        $promo = $this->check_promocode($promocode);
        if (!$promo['valid']) {
            return false;
        }
    ...
    public function check_promocode_ajax()
    {
        ...
        if (!$promocode) {
            wp_send_json_error('Enter the promo code');
        }
        ...
        if ($result['valid']) {
            $response_data = [
                ...
                'message' => $result['is_free']
                    ? 'рџЋ‰ Promocode applied! The car will be hidden for free!'
                    : 'Promocode applied! New price: $' . $result['price'],
